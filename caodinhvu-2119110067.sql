...
-- Thời gian đã tạo: Th5 11, 2021 lúc 04:31 PM
...
--
-- Cơ sở dữ liệu: `caodinhvu_2119110067`
--
...
(1, '<i class=\"fas fa-mobile-alt\"></i>PHONE', 'phone', 0, 0, 1),
(2, '<i class=\"fas fa-tablet-alt\"></i>TABLET', 'tablet', 0, 0, 1),
(3, '<i class=\"fas fa-laptop\"></i>LAPTOP', 'laptop', 0, 0, 1);
...
(5, 'liên hệ', 'bottommenu1', '', '#', 3, 0, 1),
(6, 'chính sách bán hàng', 'globalnav', '', '#', 2, 0, 1),
(7, 'liên hệ', 'globalnav', '', '#', 2, 0, 1);
