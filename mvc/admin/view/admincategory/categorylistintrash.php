...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="<?php echo BASE_URL?>admincategory/categoryDelete/<?php echo $c['catId']?>" onclick="return confirm('Bạn có chắc chăn xóa vĩnh viễn sản phảm này?');">Xóa vĩnh viễn</a> |
        <a href='<?php echo BASE_URL.'admincategory/categoryUnTrash/'.$c['catId']?>'onclick="return confirm('Bạn có chắc chăn khôi phục sản phảm này?');">khôi phục</a>
      </td>
    </tr>
    <?php }?>
